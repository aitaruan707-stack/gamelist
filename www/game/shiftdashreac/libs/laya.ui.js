! function(t, e) {
    ...
    class h extends e.Graphics {
        ...
        _createDrawTexture(t, s = 0, i = 0, h = 0, r = 0, a = null, l = 1, n = null, o = null, _) {
            ...
            return this._sp && (this._sp._renderType |= e.SpriteConst.GRAPHICS, this._sp._setRenderType(this._sp._renderType)), e.DrawTextureCmd.create.call(this, t, s, i, h, r, a, l, n, o, _)
        }
        changeSource() {
            this._isChanged = !1;
            var t = this._source;
        ...
        static getTexture(t, s, i, h, r) {
            var a;
            return h <= 0 && (h = 1), r <= 0 && (r = 1), t.$_GID || (t.$_GID = e.Utils.getGID()), a && a._getSource() || (a = e.Texture.createFromTexture(t, s, i, h, r)), a
        }
        _setDrawGridCmd(t) {
            var e = this._source;
    ...
    r.EMPTY = null, e.ILaya.regClass(r), r.EMPTY = new r, e.ClassUtils.regClass("laya.ui.Widget", r), e.ClassUtils.regClass("Laya.Widget", r);
    class a extends e.Event {}
    a.SHOW_TIP = "showtip", a.HIDE_TIP = "hidetip", e.ILaya.regClass(a), e.ClassUtils.regClass("laya.ui.UIEvent", a), e.ClassUtils.regClass("Laya.UIEvent", a);
    class l {
    ...
    class n extends e.Sprite {
        constructor(t = !0) {
            super(), this._anchorX = NaN, this._anchorY = NaN, this._widget = r.EMPTY, t && (this.preinitialize(), this.createChildren(), this.initialize())
        }
        destroy(t = !0) {
        ...
        _sizeChanged() {
            isNaN(this._anchorX) || (this.pivotX = this.anchorX * this.width), isNaN(this._anchorY) || (this.pivotY = this.anchorY * this.height), this.event(e.Event.RESIZE), this._widget !== r.EMPTY && this._widget.resetLayout()
        }
        get tag() {
            return this._tag
        }
    ...
    class y extends c {
        ...
        _createItems(t, e, s) {
            ...
            if (this.cacheContent) {
                var l = new c;
                l.cacheAs = "normal", l.pos((this._isVertical ? 0 : t) * r, (this._isVertical ? t : 0) * a), this._content.addChild(l), i = l
            } else {
            ...
            for (var d = t; d < s; d++)
                for (var u = 0; u < e; u++)(h = n && n.length ? n.pop() : this.createItem()).x = (this._isVertical ? u : d) * r - i._x, h.y = (this._isVertical ? d : u) * a - i._y, h.name = "item" + (d * e + u), i.addChild(h), this.addCell(h)
        }
        createItem() {
            var t = [];
        ...
        onScrollBarChange(t = null) {
            ...
            if (this.cacheContent) a = i + 1, this._createdLine - h < a && (this._createItems(this._createdLine, s, this._createdLine + a), this.renderItems(this._createdLine * s, 0), this._createdLine += a);
            else {
                var r = h * s,
                    a = 0;
                let t = !0;
                var l = 0;
                r > this._startIndex ? (a = r - this._startIndex, l = this._startIndex + s * (i + 1), this._isMoved = !0) : r < this._startIndex && (a = this._startIndex - r, t = !1, l = this._startIndex - 1, this._isMoved = !0);
                for (var n = 0; n < a; n++) {
                    if (t) {
    ...
    class b extends n {
        ...
        onlistItemMouse(t, s) {
            ...
            if (i === e.Event.MOUSE_OVER || i === e.Event.MOUSE_OUT) {
                ...
                r && (i === e.Event.ROLL_OVER ? (r.bgColor = this._itemColors[0], r.color = this._itemColors[1]) : (r.bgColor = null, r.color = this._itemColors[2]))
    ...
    class D extends c {
        ...
        renderItem(t, s) {
            ...
            if (i) {
                ...
                r && (2 == r.clipY ? r.index = i.isDirectory ? 0 : 1 : r.index = i.isDirectory ? i.isOpen ? 1 : 0 : 2), this._renderHandler && this._renderHandler.runWith([t, s])
            }
        }
        onArrowClick(t) {
    ...
    class A extends H {
        ...
        changeItems() {
            ...
            this.sortItem(t);
            var r = 0;
            for (s = 0, i = t.length; s < i; s++)(h = t[s]).x = r, r += h.width * h.scaleX + this._space, this._align == A.TOP ? h.y = 0 : this._align == A.MIDDLE ? h.y = .5 * (e - h.height * h.scaleY) : this._align == A.BOTTOM && (h.y = e - h.height * h.scaleY);
            this._sizeChanged()
        }
    }
    ...
    class N extends H {
        ...
        changeItems() {
            ...
            this.sortItem(t);
            var r = 0;
            for (s = 0, i = t.length; s < i; s++)(h = t[s]).y = r, r += h.height * h.scaleY + this._space, this._align == N.LEFT ? h.x = 0 : this._align == N.CENTER ? h.x = .5 * (e - h.width * h.scaleX) : this._align == N.RIGHT && (h.x = e - h.width * h.scaleX);
            this._sizeChanged()
        }
    }
    ...
    class Y extends e.Scene {
        constructor() {
            super(!1), this._watchMap = {}, this._anchorX = NaN, this._anchorY = NaN, this._widget = r.EMPTY, this.createChildren()
        }
        static __init__() {
    ...
    class W extends n {
        constructor() {
            super(), this._tipBox = new n, this._tipBox.addChild(this._tipText = new e.Text), this._tipText.x = this._tipText.y = 5, this._tipText.color = W.tipTextColor, this._defaultTipHandler = this._showDefaultTip, e.ILaya.stage.on(a.SHOW_TIP, this, this._onStageShowTip), e.ILaya.stage.on(a.HIDE_TIP, this, this._onStageHideTip), this.zOrder = 1100
        }
        _onStageHideTip(t) {
